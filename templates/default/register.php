...
<td width="7" align="left" valign="middle" ></td>
                ...
                <td align="left"></td>
                            ...
                            <tr>
                              ...
                              <td colspan="2" valign="middle" class="input"><input  type="text" id="address" name="address" maxlength="255" value="" />
                            ...
                            <tr>
                              ...
                              <td colspan="2" valign="middle" class="input"><input  type="text" id="phone" name="phone" maxlength="20" value="" />
