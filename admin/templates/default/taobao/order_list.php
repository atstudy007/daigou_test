...
<div class="headbar">
    <div class="position"><span>商城管理</span><span>></span><span>订单管理</span><span>></span><span>订单列表</span></div>
    <div class="operating" style="position:relative; overflow:visible ">
        ...
        <div id="content_search_form">
            <form method="get" action="<?php echo backend_url('taobao/order/view'); ?>">
        ...
        <div class="search f_r">
            <form name="serachuser" action="<?php echo backend_url('taobao/order/view'); ?>" method="get">
                <select class="normal" style="width:auto" name="role" onchange="location='<?php echo backend_url('taobao/order/view'); ?>?status='+this.value;">
...
<div class="content">
        <form id="content_list_form" method="post" action="<?php echo backend_url('taobao/order/del/'); ?>">
            <table id="list_table" class="list_table">
                ...
                <?php foreach($orders as $v) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo backend_url('taobao/order/detail/'.$v->id); ?>"><img class="operator" src="images/icon_edit.gif" alt="修改" title="修改"></a>
                            <a class="confirm_delete" href="<?php echo backend_url('taobao/order/del/'.$v->id); ?>"><img class="operator" src="images/icon_del.gif" alt="删除" title="删除"></a>
                        </td>
                    </tr>
                <?php endforeach; ?>
                </tbody>
